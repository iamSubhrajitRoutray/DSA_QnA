...
# It sort out the elements in the given array in ascending order and then...
...
# As we now our array is sorted in ascendimg form so we called the value stored in last index.
ele = arr[len(arr) - 1]
