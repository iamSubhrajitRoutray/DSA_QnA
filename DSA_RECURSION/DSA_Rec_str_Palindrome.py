...
def string_palindrome(i, s):
    ...
    # If i exceeds half of the string, all the elements have been compared : string is a palindrome, return True.
    
    if i >= len(s) // 2:
    
        return print('YES, The given string is palindrome.')
    
     # If the start and end characters are not equal : it's not a palindrome, return False.
